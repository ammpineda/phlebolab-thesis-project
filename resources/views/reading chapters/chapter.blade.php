...
<head>
    ...
    <title>PhleboLab | Reading Content</title>
    ...
    <div class="main-content">   
        <div class="container">
            <div class="content">
                ...
                <iframe class="pdf-iframe" src="{{ asset('storage/pdf/' . $readingMaterial->reading_material_pdf) }}"></iframe>
                <form action="{{ route('chapter-done', ['chapter' => $readingMaterial->id]) }}" method="POST">
                    @csrf
