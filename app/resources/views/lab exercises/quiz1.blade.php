...
<head>
    ...
    <title>PhleboLab | Laboratory Exercise 1 - Practice Quiz</title>
...
<body>
        <div class="instr_box">
            <div class="info-title"><span>Lab 1 Review Instructions</span></div>
            <div class="info-list">
        ...
        <div class="quiz_box">
            <header>
                <div class="title">PhleboLab Lab 1 Review</div>
            </header>
            <section>
        ...
        <div class="result_box">
            ...
            <div class="buttons">
                <form action="{{ route('lab1-done') }}" method="POST">
                    @csrf
                    <button class="quit" type="submit" class="toggle-button"> Back to Laboratory Exercises</button>
                </form>
            </div>
        </div>
        <script src="{{ asset('/js/practice quiz 1/questions.js') }}"></script>
        <script src="{{ asset('/js/practice quiz 1/script.js') }}"></script>
