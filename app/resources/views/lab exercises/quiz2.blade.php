...
<head>
    ...
    <title>PhleboLab | Laboratory Exercise 2 - Practice Quiz</title>
...
<body>
        <div class="instr_box">
            <div class="info-title"><span>Lab 2 Review Instructions</span></div>
            <div class="info-list">
        ...
        <div class="quiz_box">
            <header>
                <div class="title">PhleboLab Lab 2 Review</div>
            </header>
            <section>
        ...
        <div class="result_box">
            ...
            <div class="buttons">
                <form action="{{ route('lab2-done') }}" method="POST">
                    @csrf
                    <button class="quit" type="submit" class="toggle-button"> Back to Laboratory Exercises</button>
                </form>
            </div>
        </div>
        <script src="{{ asset('/js/practice quiz 2/questions.js') }}"></script>
        <script src="{{ asset('/js/practice quiz 2/script.js') }}"></script>
